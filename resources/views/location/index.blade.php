...
@if(in_array("15", $modulePermission))
            <a href="{!!URL('admin/location/create')!!}" class="btn btn-primary "><i class="fa fa-plus"></i>Add Location</a>
             <a href="{!!URL('admin/deactiveLocation')!!}" class="btn btn-danger pull-right"><i class="fa fa-remove"></i>Deactive Location</a>
@endif
             </h4><hr/>
...
"pageLength": '500',
    ...
    $.ajax({
  method: "GET",
  url: "http://firstaddigital.com/otherservices/reboot_services.php",
  data: ""
})
  .done(function( msg ) {
