             ...
             <div class="row">
                ...
                <div class="form-group"> 
                  ...
                  <div> 
                    <select name="screen_size" class="form-control">
                      ...
                      <option value="1" <?php if($screen_size == '1'){ echo "selected"; } ?>>32 Inch</option>
                      <option value="2" <?php if($screen_size == '2'){ echo "selected"; } ?> >36 Inch</option>
                      <option value="3" <?php if($screen_size == '3'){ echo "selected"; } ?> >42 Inch</option>
                      <option value="4" <?php if($screen_size == '4'){ echo "selected"; } ?> >52 Inch</option>
                    </select>
                  </div>
                </div>
              </div>
                ...
                <div class="form-group"> 
                  ...
                  <div> 
                    ...
                    <select name="screen_type" class="form-control">
                      ...
                      <option value="1" <?php if($screen_type == '1'){ echo "selected"; } ?>>LED</option>
                      <option value="2" <?php if($screen_type == '2'){ echo "selected"; } ?>>LCD</option>
                    </select>
                  </div>
                </div>
              </div>
               ...
               <div class="col-md-6">
                <div class="form-group"> 
                  ...
                  <div> {{ Form::text('city', $city, array('class' => 'form-control','placeholder'=>'City','required'=>'required')) }} </div>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group"> 
                  ...
                  <div> {{ Form::textarea('location', $location_field, array('class' => 'form-control','placeholder'=>'Address','required'=>'required')) }} </div>
                </div>
              </div>
