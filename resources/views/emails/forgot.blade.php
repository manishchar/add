...
<body style="margin: 0px; background-color: #fff;color:#000000;">

<div style="border: 1px solid gray;padding: 10px 5%;">
<div>  
Hello {{ $content['client']->fname }},
<div>
<br/>
<br/>
...
<a target="_blank" href="{{ URL('/forgot_password').'/'.encrypt($content['client']->id) }}">Click To change your password</a>

<br/>
<p>change password Link Blow</p>
<p>{{ URL('/forgot_password').'/'.encrypt($content['client']->id) }}</p>
...
<img src="{{URL('/')}}/assets/frontend/img/logo-green.png"  height="35" width="174"/>
</td>
