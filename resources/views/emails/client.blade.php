...
<div>  
<h1>FirstAd	advertisement agency </h1>
<br/>
<br/>
<div>
...
<tr>
<td>Name</td>
<td>{{ $content['client']->fname }}</td>
</tr>
<tr>
<td>Mobile</td>
<td>{{$content['client']->mobile}}</td>
</tr>
<tr>
<td>User Id</td>
<td>{{$content['client']->email}}</td>
</tr>
@if($content['password_flag'])
<tr>
<td>Password</td>
<td>123456</td>
</tr>
...
<br/>
<a target="_blank" href="{{ URL('/') }}">Go to Website</a>
<br/>
<p>Website Link Blow</p>
<p>{{ URL('/') }}</p>
<br/>
<p>Regards,</p>
...
<img src="{{URL('/')}}/assets/frontend/img/logo-dark.png"  height="35" width="174"/>
</td>
