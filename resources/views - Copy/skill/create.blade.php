    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-body"> @if(Request::segment(4)==='edit')
          {{ Form::model($skill, array('route' => array('skill.update', $skill->id), 'method' => 'PUT')) }}
          <?php  
                $name                       = $skill->name;
            ?>
          @else
          {{ Form::open(array('url' => 'admin/skill')) }}
             ...
             <div class="row">
              <div class="col-md-6">
                <div class="form-group"> 
                  <div> {{ Form::text('name', $name, array('class' => 'form-control','placeholder'=>'Skill Name','required'=>'required')) }} </div>
                </div>
              </div>
             <div class="col-md-4">
