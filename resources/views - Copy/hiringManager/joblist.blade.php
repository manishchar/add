...
<div id="candidateModal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
  ...
  <div class="row form-group">
      ...
      <div class="col-sm-12">
     <select class="form-control myForm" name="jobid" id="jobid">
  ...
  <div class="col-sm-6">
    ...
    <div class="col-sm-12">
        <input type="text" class="form-control myForm" id="fname" name="fname" placeholder="Enter First Name" >
    </div>
  </div>
  <div class="col-sm-6">
    <label class="control-label col-sm-10" for="lanme">Last Name( <span class="text text-danger">*</span> ):</label>
    <div class="col-sm-12"> 
        <input type="text" class="form-control myForm" id="lname" name="lname" placeholder="Enter Last Name">
    </div>
  </div>
  ...
  <div class="col-sm-6">
    ...
    <div class="col-sm-12">
        <input type="email" class="form-control myForm" id="email" name="email"  placeholder="Enter email">
    </div>
  </div>
  <div class="col-sm-6">
    <label class="control-label col-sm-10" for="pwd">Phone( <span class="text text-danger">*</span> ):</label>
    <div class="col-sm-12"> 
        <input type="number" class="form-control myForm" id="phone" name="phone" placeholder="Enter Phone" >
    </div>
  </div>
  </div>
  <div class="row form-group">
  <div class="col-sm-6">
    ...
    <div class="col-sm-12">
        <input type="email" class="form-control" id="alternate_email" name="alternate_email" placeholder="Enter Alternate Email">
    </div>
  </div>
  <div class="col-sm-6">
    <label class="control-label col-sm-10" for="alternate_phone">Alternate Phone:</label>
    <div class="col-sm-12"> 
        <input type="number" class="form-control" id="alternate_phone" name="alternate_phone" placeholder="Enter Alternate Phone">
    </div>
  </div>
  </div>
  <div class="row form-group">
...
<!--    <label class="control-label col-sm-10" for="experience">Total Experience:</label>
  ...
  <div class="col-sm-6">
    ...
    <div class="col-sm-12"> 
          <select class="form-control myForm"  id="Tags" name="Tags" >
              <option value="0"  disabled="" selected="">Select Tag</option>
  ...
  <div class="row form-group exp">
  <div class="col-sm-12">
    <label class="control-label col-sm-10" for="email">Upload Cv:</label>
    <div class="col-sm-6">
        <input type="file" name="UploadedCVPath">
    </div>
  </div>
