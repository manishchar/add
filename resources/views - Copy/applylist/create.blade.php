      ...
      <div class="card m-b-30">
        <div class="card-body">
           ...
           {{ Form::open(array('url' => 'admin/candidate-update','enctype'=>'multipart/form-data')) }}
            ...
            @else
            {{ Form::open(array('url' => 'admin/candidate-add','enctype'=>'multipart/form-data')) }}
            ...
            ?>
            @endif
            {!! Form::hidden('JobID',$jobmasterall->id) !!}
          ...
          <div class="col-md-4">
           ...
           <div class="col-md-4">
            <div class="form-group">
             ...
             <select name="Source" class="form-control" style="height: 34px;">
