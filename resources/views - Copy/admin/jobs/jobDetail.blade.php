    ...
    <div class="col-sm-12">
      <div class="page-title-box">
        ...
        <h4 class="page-title">{{ $jobmaster->JobTitle }}</h4>
         ...
         <div>
          Apply Job Link : <input type="" class="form-control" name="" readonly="" value="{{URL::to('jobApply/'.$jobmaster->org->orgSlug.'/'.$jobmaster->jobSlug) }}">
