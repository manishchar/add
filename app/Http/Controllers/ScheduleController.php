...
public function getSchedule(Request $request)
    {
        ...
        $videoLength=Advertise::videoLenghtEdit($schedule->location_id,$schedule->id);
        ...
        foreach ($advertises as $key => $value) {
           $videoLength[]=Advertise::videoLenghtEdit($value->location_id,$value->id);
        }
    ...
    public function getAdds()
    {
        ...
        foreach ($advertises as $key => $value) {
            $videoLength[]=Advertise::videoLenghtForAdd($value->location_id);
        }
